...
namespace BlogProject.Repository.Migrations
{
    ...
    [Migration("20220829111928_initial")]
            ...
            modelBuilder.Entity("BlogProject.Core.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Body = "Blog Body 1",
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 29, 14, 19, 27, 828, DateTimeKind.Local).AddTicks(8196),
                            Title = "Blog Title 1"
                        },
                        new
                        {
                            ...
                            Body = "Blog Body 2",
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 8, 29, 14, 19, 27, 828, DateTimeKind.Local).AddTicks(8211),
                            Title = "Blog Title 2"
                        },
                        new
                        {
                            ...
                            Body = "Blog Body 3",
                            CategoryId = 3,
                            CreatedDate = new DateTime(2022, 8, 29, 14, 19, 27, 828, DateTimeKind.Local).AddTicks(8212),
                            Title = "Blog Title 3"
                        },
                        new
                        {
                            ...
                            Body = "Blog Body 4",
                            CategoryId = 3,
                            CreatedDate = new DateTime(2022, 8, 29, 14, 19, 27, 828, DateTimeKind.Local).AddTicks(8214),
                            Title = "Blog Title 4"
                        });
                });
